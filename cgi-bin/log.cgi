...
<body>
  ...
  <div id="path"><p>Ti trovi in: <span xml:lang="en"><a href="../public_html/index.html">Home</a></span>&gt <span xml:lang="en">
  Control Panel</span></p></div>
	...
	<div id="section">
	<h2>Benvenuto</h2> 
<img src="../public_html/immagini/wellcome.jpg" alt="immagine di benvenuto" ></img>
